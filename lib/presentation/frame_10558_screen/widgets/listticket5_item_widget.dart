...
class Listticket5ItemWidget extends StatelessWidget {
  Listticket5ItemWidget(this.listticket5ItemModelObj);

  Listticket5ItemModel listticket5ItemModelObj;

  var controller = Get.find<Frame10558Controller>();
