import '../report_downloaded_successfully_screen/widgets/listvideocamera1_item_widget.dart';
...
class ReportDownloadedSuccessfullyScreen
    extends GetWidget<ReportDownloadedSuccessfullyController> {
  @override
                            ...
                            child: Obx(
                              () => ListView.separated(
                                ...
                                itemCount: controller
                                    .reportDownloadedSuccessfullyModelObj
                                    .value
                                    .listvideocamera1ItemList
                                    .length,
                                itemBuilder: (context, index) {
                                  Listvideocamera1ItemModel model = controller
                                      .reportDownloadedSuccessfullyModelObj
                                      .value
                                      .listvideocamera1ItemList[index];
                                  return Listvideocamera1ItemWidget(
                                    model,
                                  );
                                },
                              ),
