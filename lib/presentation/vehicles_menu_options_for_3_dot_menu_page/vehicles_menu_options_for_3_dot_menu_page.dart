import '../vehicles_menu_options_for_3_dot_menu_page/widgets/listd123_item_widget.dart';
import 'controller/vehicles_menu_options_for_3_dot_menu_controller.dart';
import 'models/listd123_item_model.dart';
import 'models/vehicles_menu_options_for_3_dot_menu_model.dart';
...
class VehiclesMenuOptionsFor3DotMenuPage extends StatelessWidget {
  VehiclesMenuOptionsFor3DotMenuController controller = Get.put(
      VehiclesMenuOptionsFor3DotMenuController(
          VehiclesMenuOptionsFor3DotMenuModel().obs));
                                        ...
                                        child: Obx(
                                          () => ListView.separated(
                                            ...
                                            itemCount: controller
                                                .vehiclesMenuOptionsFor3DotMenuModelObj
                                                .value
                                                .listd123ItemList
                                                .length,
                                            itemBuilder: (context, index) {
                                              Listd123ItemModel model = controller
                                                  .vehiclesMenuOptionsFor3DotMenuModelObj
                                                  .value
                                                  .listd123ItemList[index];
                                              return Listd123ItemWidget(
                                                model,
                                              );
                                            },
                                          ),
                                  ...
                                  child: Row(
                                    children: [
                                      AppbarImage(
                                        ...
                                        svgPath:
                                            ImageConstant.imgSearchBlueGray500,
                                        margin: getMargin(
                                          left: 12,
                                          top: 7,
                                          bottom: 7,
