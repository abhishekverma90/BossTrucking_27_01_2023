...
class VehiclePageItemWidget extends StatelessWidget {
  VehiclePageItemWidget(this.vehiclePageItemModelObj);

  VehiclePageItemModel vehiclePageItemModelObj;

  var controller = Get.find<VehiclePageController>();
              ...
              child: Row(
                ...
                children: [
                  ...
                  CustomButton(
                    ...
                    variant: ButtonVariant.FillAmber600,
