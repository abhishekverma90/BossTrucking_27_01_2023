...
class ListcreatefromframeFourItemWidget extends StatelessWidget {
  ListcreatefromframeFourItemWidget(this.listcreatefromframeFourItemModelObj);

  ListcreatefromframeFourItemModel listcreatefromframeFourItemModelObj;
