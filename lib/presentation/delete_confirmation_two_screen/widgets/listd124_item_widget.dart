...
class Listd124ItemWidget extends StatelessWidget {
  Listd124ItemWidget(this.listd124ItemModelObj);

  Listd124ItemModel listd124ItemModelObj;

  var controller = Get.find<DeleteConfirmationTwoController>();
