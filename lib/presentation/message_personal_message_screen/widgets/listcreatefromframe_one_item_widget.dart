...
import '../models/listcreatefromframe_one_item_model.dart';
...
class ListcreatefromframeOneItemWidget extends StatelessWidget {
  ListcreatefromframeOneItemWidget(this.listcreatefromframeOneItemModelObj);

  ListcreatefromframeOneItemModel listcreatefromframeOneItemModelObj;

  var controller = Get.find<MessagePersonalMessageController>();
